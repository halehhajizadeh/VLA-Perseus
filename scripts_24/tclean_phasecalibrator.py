...
# === Define the phasecenter from your screenshot ===
phasecenter = "J2000 03:36:29.7 +32.18.26"

# === Loop through all subdirectories and find *_calibrated.ms files ===
all_ms_files = []
