...
base_directory = '../data/' + specific_dirs + 'data/'
...
for ms in ms_file_list:
    ...
    img_filename =  "../data/epoch/" + specific_dirs + "tclean/" +  "ms-2.5arcsec-nit" + str(nit) + "-" + "-awproject"
...
for ms in ms_file_list:
    ...
    print(f"Stokes: I, folder: {ms} is started ...")
    exportfits(
        imagename =  "../data/epoch/" + specific_dirs + "tclean/" +  "ms-2.5arcsec-nit" + str(nit) + "-" + "-awproject.image",
        fitsimage =  "../data/epoch/" + specific_dirs + "fits/" +  "ms-2.5arcsec-nit" + str(nit) + "-" + "-awproject.image.fits"           
    )
