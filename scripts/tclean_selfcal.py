...
mslist = ['../data/19B-053_2020_01_05_T00_25_02.102/19B-053.sb37659292.eb37664379.58853.92688378472_calibrated.ms/'
...
image_name= '102' + '-awproject-fieldAll-Stokes'+str(Stoke)+'-2.5arc-'+str(nit)+'-'+str(thresh)+'-spw16-pb'+str(pblim)+'phase_field'
