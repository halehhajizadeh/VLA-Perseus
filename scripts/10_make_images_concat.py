...
for stok in stokes1:
    for s in spw:
        for channel in channels:
            ...
            img_filename = os.path.join("../data/concat/", "03:25:30.000000_+29.29.59.99999/", "Images/img" + str(nit) + "/tclean/", "spw" + str(s) + '-' + str(channel) + "-2.5arcsec-nit" + str(nit) + "-" + str(thresh) + "-" + str(stok))
