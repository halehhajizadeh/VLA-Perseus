...
xvfb-run -d ${CASAPATH}/current/bin/mpicasa ${CASAPATH}/current/bin/casa --nogui -c /lustre/aoc/observers/nm-12934/VLA-Perseus/scripts/10_make_images.py >>file.txt 2>&1